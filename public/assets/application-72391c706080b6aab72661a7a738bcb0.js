...
//////////////////////////////////////////////////////////////////////
// Pano2VR pro 4.1.0/3404 HTML5/CSS3 & WebGL Panorama Player        //
// License: Reid Paxton                                             //
...
a.loop-1);if((1==a.mode||2==a.mode||3==a.mode||5==a.mode)&&0<=a.loop)a.obj.autoplay=m;0<=e?p[e]=a:p.push(a);0<a.obj.childNodes.length&&(b.a.appendChild(a.obj),a.obj.addEventListener("ended",function(){if(0<this.f)return this.f--,this.currentTime=0,this.play(),m},r))}}catch(h){X(h)}}function Aa(){var a;a=document.createElement("div");a.innerHTML=Tc("");
...
Sc&&(a+="background-image: url(data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7);"),a+=M+"user-select: none;",C.setAttribute("style",a),b.a.appendChild(C),T=document.createElement("canvas"),a="top:  0px;left: 0px;width:  100px;height: 100px;overflow: hidden;position:absolute;z-index: 900;"+(M+"user-select: none;"),T.setAttribute("style",a),b.a.appendChild(T),I=document.createElement("div"),I.setAttribute("style","top:  0px;left: 0px;position:absolute;padding: 3px;visibility: hidden;z-index: 1100;"),
